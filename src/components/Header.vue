                    ...
                    >
                      ...
                      <td>
                        <button 
                          ...
                          type="button"
                          @click="$emit('eliminar-producto', producto.id)">X
                        </button>
                      </td>
                    </tr>
                  </tbody>
                </table>
                <p v-if="carrito.length > 0" class="text-end">Total pagar: <span class="fw-bold">${{ totalPgar }}</span></p>
